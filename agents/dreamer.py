...
if __name__ == "__main__":
    agent = DreamerAgent()
    sample_params = {
        # The prompt is usually generated by the FLUX prompt constructor, but we can test with a sample
        "prompt": "the color of a forgotten sound, ethereal, surreal, cinematic lighting, hyper-detailed, 8k",
